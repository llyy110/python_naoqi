...
def main(ip):
    ...
    # behavior_mng_service.stopBehavior('untitled-60b53b/behavior_1')
...
if __name__ == "__main__":  # 定义三台机器人的IP地址和端口号
    ...
    l = []
    while True:
        ip = raw_input("Please enter an IP address (or 'q' to quit): ")
        if ip.lower() == 'q':
            break
        thread = threading.Thread(target=main, args=(ip,))
        l.append(thread)
    for i in l:
        i.start()
    # l = []
    ...
    # robot1_ip = "192.168.3.128"  # 创建三个线程来控制三台机器人
    # robot1_port = 9559
    # robot2_ip = "192.168.3.122"
    # robot2_port = 9559
    # robot3_ip = "192.168.3.129"
    # robot3_port = 9559
    # robot4_ip = "192.168.3.126"
    # robot4_port = 9559
    # robot5_ip = "192.168.3.124"
    # robot5_port = 9559
    ...
    # thread5 = threading.Thread(target=main, args=(robot5_ip,))
    # thread1.start()
    # thread2.start()
    # thread3.start()
    # thread4.start()
